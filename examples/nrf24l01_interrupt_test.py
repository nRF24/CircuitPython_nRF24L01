...
def master():
    ...
    print(f'\t"on data ready" event test {"" if nrf.irq_dr else "un"}successful')
    ...
    _ping_and_prompt()  # CE pin is managed by this function
    print(f'\t"on data sent" event test {"" if nrf.irq_ds else "un"}successful')
    ...
    _ping_and_prompt()  # CE pin is managed by this function
    print(f'\t"on data failed" event test {"" if nrf.irq_df else "un"}successful')
